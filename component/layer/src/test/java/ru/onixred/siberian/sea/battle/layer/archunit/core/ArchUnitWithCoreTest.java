...
import ru.onixred.arch.unit.helper.rule.AnnotationsForAllClassesAssignableToClassRuleTest;
import ru.onixred.arch.unit.helper.rule.AnnotationsForAllPublicMethodsToClassRuleTest;
import ru.onixred.arch.unit.helper.rule.ComponentDependencyMetricsRuleTest;
import ru.onixred.arch.unit.helper.rule.ComponentMetric;
import ru.onixred.arch.unit.helper.rule.ComponentMetricLayer;
import ru.onixred.arch.unit.helper.rule.LakosMetric;
import ru.onixred.arch.unit.helper.rule.LakosMetricsRuleTest;
import ru.onixred.arch.unit.helper.rule.LayeredRuleTest;
import ru.onixred.arch.unit.helper.rule.NamingConventionInPackageRuleTest;
import ru.onixred.arch.unit.helper.rule.OnlyDependOnClassesRuleTest;
import ru.onixred.arch.unit.helper.rule.OnlyHaveNameNotMatchingRuleTest;
import ru.onixred.arch.unit.helper.rule.PackageContainmentRuleTest;
