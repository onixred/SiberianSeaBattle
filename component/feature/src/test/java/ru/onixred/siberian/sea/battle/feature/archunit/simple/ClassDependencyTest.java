...
import ru.onixred.siberian.sea.battle.feature.match.MatchService;
import ru.onixred.siberian.sea.battle.feature.match.action_history.ActionHistoryMapper;
...
public class ClassDependencyTest {
    ...
    void matchMapperClassDependencyTest() {
        ...
        ArchRule rule = classes().that().haveNameMatching(MatchMapper.class.getName())
                .should()
                .onlyHaveDependentClassesThat().haveNameMatching(MatchService.class.getName() + "|" + ActionHistoryMapper.class.getName());
